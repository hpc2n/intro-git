...
<small>Slides: https://hackmd.io/@hpc2n-git-2020/L2-concepts</small>
...
<!-- .slide: class="fragment" -->
 ...
 - You are **not** intended memorize any commands or low-level details. <!-- .element: class="fragment" -->
...
```graphviz
digraph {
  "file.txt" [fontcolor=green]
  "logs/" [fontcolor=green]
  "master" [fontcolor=green]
  "COMMIT_EDITMSG" [fontcolor=green]
  "index" [fontcolor=green]
  "23" [fontcolor=green]
  "b3ed5b16..." [fontcolor=green]
  "1a" [fontcolor=green]
  "098a06bf..." [fontcolor=green]
  "09" [fontcolor=green]
  "c78e6e97..." [fontcolor=green]
...
digraph {
  ...
  "HEAD" [fontcolor=green]
  "refs/" [fontcolor=green]
  "heads/" [fontcolor=green]
  "master" [fontcolor=green]
}
```
...
digraph {
  ...
  "refs/" [fontcolor=green]
  "tags/" [fontcolor=green]
  "first" [fontcolor=green]
}
```
...
digraph {
  ...
  "23ff0c41..."
  "22/" [fontcolor=green]
  "b5208beb..." [fontcolor=green]
  "d3/" [fontcolor=green]
  "c6c635fb..." [fontcolor=green]
...
### HEAD and other references (again)
 ...
 - Let's see how to `HEAD` and `master` look at this point:
